...
class TestEvaluator:
    ...
    def __init__(
        ...
        logging.info(f"TestEvaluator initialized with device: {self.device}")
    ...
    def evaluate(self) -> Dict[str, float]:
        ...
        with torch.no_grad():
            for batch_idx, batch in enumerate(tqdm(self.test_loader, desc="Evaluating model")):
                ...
                for b in range(batch_size):
                    ...
                    if self.vis_manager and self.test_config.get("episode_visualizations", True):
                        self.vis_manager.visualize_episode(
                            ...
                            dates=ep_dates  # Pass dates to visualization
                        )
